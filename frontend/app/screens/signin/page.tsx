    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <div onClick={() => router.push('/screens/forgot-password')} className="cursor-pointer font-semibold text-orange-400 hover:text-orange-300">
                    Forgot password?
                  </div>
                </div>
              </div>
          ...
          <p className="mt-10 text-center text-sm text-gray-400">
            Not a member?{' '}
            <button onClick={() => router.push('/screens/signup')} className="font-semibold leading-6 text-orange-400 hover:text-orange-300">
              Sign Up
            </button>
          </p>
        </div>
